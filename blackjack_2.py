...
def blackjack():
    ...
    # Aの値を決める(4通り)
    def decide_Avalue_1(other_value: int) -> int:
        if other_value <= 10:
            return 11
        else:  # other_value >= 11
            return 1

    def decide_Avalue_2(other_value: int) -> int:
        if other_value <= 9:
            return 12
        else:  # other_value >= 10
            return 2

    def decide_Avalue_3(other_value: int) -> int:
        if other_value <= 8:
            return 13
        else:  # other_valuer >= 9
            return 3

    def decide_Avalue_4(other_value: int) -> int:
        if other_value <= 7:
            return 14
        else:  # other_value >= 8
            return 4
        ...
        def calc_score(self) -> int:
            ...
            for cl in self.cardlist:
                if cl.number != 'A':
                    ...
                    A_count += 1
            if A_count == 1:
                score += decide_Avalue_1(score)
            elif A_count == 2:
                score += decide_Avalue_2(score)
            elif A_count == 3:
                score += decide_Avalue_3(score)
            elif A_count == 4:
                score += decide_Avalue_4(score)
            return score
